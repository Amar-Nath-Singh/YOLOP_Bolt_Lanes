...
def image_callback(data):
        ...
        try:
            output_pub.publish(bridge.cv2_to_imgmsg(lane, "bgr8"))
        except CvBridgeError as e:
            print(e)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, help='source')  # file/folder   ex:inference/images
    ...
    parser.add_argument('--load_video', type=bool, default=True)
